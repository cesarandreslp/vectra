...
import { getCoreStats, getVotersGeo, getGeoStats, getVotingStationsGeo, getJurisdictionStats, getElectoresPorComuna, getElectoresPorBarrio, getTestigosGeo, getLeaderRanking, getCentroMunicipio } from './actions'
...
export default async function CoreDashboardPage() {
  const [stats, puntos, geoStats, puestos, jurisdiccion, comunas, barrios, testigos, ranking, centro] = await Promise.all([
    getCoreStats(),
    getVotersGeo(),
    getGeoStats(),
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        <MapaElectores puntos={puntos} geoStats={geoStats} puestos={puestos} comunas={comunas} barrios={barrios} testigos={testigos} centro={centro} />
